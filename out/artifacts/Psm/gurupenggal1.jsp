    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <form action="#" class="sky-form" method="post">
                <header>Peperiksaan Penggal 1</header>
                    ...
                    <section>
                        ...
                        <label class="select" >
                            <select name="kelas">
                                ...
                                <option href="#" value="bistari">Bistari</option>
                                <option href="#" value="cerdik">Cerdik</option>
                                <option href="#" value="dia">Dia</option>

                            </select>
                            <i></i>
                        </label>
                        <a href="guruarif.jsp">Arif
                    </section>
