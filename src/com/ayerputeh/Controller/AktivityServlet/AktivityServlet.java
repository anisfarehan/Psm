package com.ayerputeh.Controller.AktivityServlet;
 ...
 */
@WebServlet( "/AktivityServlet")
public class AktivityServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<li class=\"active\"><a href=\"AktivityServlet\">Aktiviti Sekolah</a></li>");
