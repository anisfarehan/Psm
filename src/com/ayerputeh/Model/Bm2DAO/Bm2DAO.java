package com.ayerputeh.Model.Bm2DAO;
 ...
 */
public class Bm2DAO extends DBConnectionManager {
    protected transient boolean isNewRecord = true;
    protected transient String tableName = "bm2";
    ...
    private transient List<Bm2DAO> logins;
...
//            return this.logins.get(id - 1);
    ...
    * */
    ...
    //retrive single login from the database
    public Bm2DAO findByNRIC(String NRIC) {
        this.isNewRecord = false;
...
//            return this.logins.get(id - 1);
    ...
    public List<Bm2DAO> getAllLogins() {
        try {
            if (this.conn.isClosed())
                this.conn = getConnection();
    ...
    protected Bm2DAO processRow(ResultSet rs) throws SQLException {
