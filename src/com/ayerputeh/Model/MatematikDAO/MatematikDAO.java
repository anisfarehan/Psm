package com.ayerputeh.Model.MatematikDAO;
 ...
 */
public class MatematikDAO extends DBConnectionManager {
    protected transient boolean isNewRecord = true;
    protected transient String tableName = "matematik";
    ...
    private transient List<MatematikDAO> logins;
    ...
    * */
    ...
    public MatematikDAO read(int id) {
        ...
        try {
            ...
            MatematikDAO matematikDAO= null;
            while (rs.next()) {
                matematikDAO = this.processRow(rs);
            }
...
//            return this.logins.get(id - 1);
    ...
    * */
    ...
    //retrive single login from the database
    public MatematikDAO findByNRIC(String NRIC) {
        this.isNewRecord = false;
...
//            return this.logins.get(id - 1);
    ...
    public List<MatematikDAO> getAllLogins() {
        try {
            if (this.conn.isClosed())
                this.conn = getConnection();
    ...
    protected MatematikDAO processRow(ResultSet rs) throws SQLException {
