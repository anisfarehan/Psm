package com.ayerputeh.Model.EnglishDAO;
 ...
 */
public class EnglishDAO extends DBConnectionManager {
    protected transient boolean isNewRecord = true;
    protected transient String tableName = "english";
    ...
    private transient List<EnglishDAO> logins;
    ...
    * */
    ...
    public EnglishDAO read(int id) {
        ...
        try {
            ...
            EnglishDAO englishDAO= null;
            while (rs.next()) {
                englishDAO = this.processRow(rs);
            }
...
//            return this.logins.get(id - 1);
    ...
    * */
    ...
    //retrive single login from the database
    public EnglishDAO findByNRIC(String NRIC) {
        this.isNewRecord = false;
...
//            return this.logins.get(id - 1);
    ...
    public List<EnglishDAO> getAllLogins() {
        try {
            if (this.conn.isClosed())
                this.conn = getConnection();
    ...
    protected EnglishDAO processRow(ResultSet rs) throws SQLException {
