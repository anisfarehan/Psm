package com.ayerputeh.Model.MelayuDAO;
 ...
 */
public class MelayuDAO extends DBConnectionManager {
    protected transient boolean isNewRecord = true;
    protected transient String tableName = "melayu";
    ...
    private transient List<MelayuDAO> logins;
    ...
    * */
    public void create() {
        ...
        try {
            ...
            this.preparedStmt.setInt(8, this.penggal1);
    ...
    * */
    ...
    public MelayuDAO read(int id) {
        ...
        try {
            ...
            MelayuDAO melayuDAO= null;
            while (rs.next()) {
                melayuDAO = this.processRow(rs);
            }
...
//            return this.logins.get(id - 1);
    ...
    * */
    ...
    //retrive single login from the database
    public MelayuDAO findByNRIC(String NRIC) {
        this.isNewRecord = false;
...
//            return this.logins.get(id - 1);
    ...
    public List<MelayuDAO> getAllLogins() {
        try {
            if (this.conn.isClosed())
                this.conn = getConnection();
    ...
    protected MelayuDAO processRow(ResultSet rs) throws SQLException {
